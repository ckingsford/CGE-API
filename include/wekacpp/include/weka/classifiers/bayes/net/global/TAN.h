...
#ifndef __WEKACPP_CLASSIFIERS_BAYES_NET_GLOBAL_TAN__
#define __WEKACPP_CLASSIFIERS_BAYES_NET_GLOBAL_TAN__
...
class TAN : public GlobalScoreSearchAlgorithm 
{
 private:
    bool m_bRandomOrder;
...
#endif /* __WEKACPP_CLASSIFIERS_BAYES_NET_GLOBAL_TAN__ */
